...
var RichEditor = function (_React$Component) {
  ...
  function RichEditor(props) {
    ...
    _this.insertText = function () {
      ...
      var ncs = __WEBPACK_IMPORTED_MODULE_8_draft_js__["Modifier"].insertText(contentState, selection, "[znacznik]");
        ...
        __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_8_draft_js__["Editor"], {
              ...
              styleMap: __WEBPACK_IMPORTED_MODULE_13__constants__["d" /* STYLE_MAP */],
              __source: {
                fileName: _jsxFileName,
                lineNumber: 125
              }
...
var BLOCK_TYPES = [{ label: 'Blockquote', style: 'blockquote' }, { label: 'CENTER', style: 'center' }, { label: 'LEFT', style: 'left' }, { label: 'RIGHT', style: 'right' }, { label: 'JUSTIFY', style: 'justify' }, { label: 'UL', style: 'unordered-list-item' }, { label: 'OL', style: 'ordered-list-item' }];

var INLINE_STYLES = [{ label: 'Bold', style: 'BOLD' }, { label: 'Italic', style: 'ITALIC' }, { label: 'Underline', style: 'UNDERLINE' }, { label: 'Monospace', style: 'CODE' }, { label: 'Font 16', style: 'FONT16' }];
...
//# sourceMappingURL=0.0b66d2ecbad98a20a561.hot-update.js.map