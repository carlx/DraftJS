...
var RichEditor = function (_React$Component2) {
  ...
  function RichEditor(props) {
    ...
    _this2.state = { editorState: __WEBPACK_IMPORTED_MODULE_7_draft_js__["EditorState"].createEmpty() };
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(RichEditor, [{
    ...
    value: function _onTab(e) {
      var maxDepth = 4;
      this.onChange(__WEBPACK_IMPORTED_MODULE_7_draft_js__["RichUtils"].onTab(e, this.state.editorState, maxDepth));
    }
  }, {
    key: '_toggleBlockType',
    value: function _toggleBlockType(blockType) {
      this.onChange(__WEBPACK_IMPORTED_MODULE_7_draft_js__["RichUtils"].toggleBlockType(this.state.editorState, blockType));
    }
  }, {
    key: '_toggleInlineStyle',
    value: function _toggleInlineStyle(inlineStyle) {
      this.onChange(__WEBPACK_IMPORTED_MODULE_7_draft_js__["RichUtils"].toggleInlineStyle(this.state.editorState, inlineStyle));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(
        ...
        Object(__WEBPACK_IMPORTED_MODULE_8_draft_js_export_html__["stateToHTML"])(this.state.editorState.getCurrentContent())
      );
    }
  }]);
...
//# sourceMappingURL=0.a3d70e9c54d1d361015f.hot-update.js.map