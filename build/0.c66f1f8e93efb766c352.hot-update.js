...
var BLOCK_TYPES = [{ label: 'Blockquote', style: 'blockquote' }, { label: 'CENTER', style: 'center', icon: 'fa fa-align-center' }, { label: 'LEFT', style: 'left', icon: 'fa fa-align-left' }, { label: 'RIGHT', style: 'right', icon: 'fa fa-align-right' }, { label: 'JUSTIFY', style: 'justify', icon: 'fa fa-align-justify' }, { label: 'UL', style: 'unordered-list-item', icon: 'fa fa-ul' }, { label: 'OL', style: 'ordered-list-item', icon: 'fa fa-ol' }];
...
//# sourceMappingURL=0.c66f1f8e93efb766c352.hot-update.js.map